...
def parse_args():
    ...
    epilog="""Examples:
    1. list of the plugins
        # python3 hist.py -l

    2. histogram of fom_req plugin
        # python3 hist.py -f png -o write.png -v -u ms -p fom_req
...
if __name__ == "__main__":
    ...
    if args.plugin:
        hist(args.db, args.plugin, args.range, args.fmt, args.out, args.time_unit, args.rows, args.size)
