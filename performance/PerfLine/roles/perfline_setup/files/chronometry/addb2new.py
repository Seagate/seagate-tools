...
db_create_delete_tables = [client_to_dix, dix_to_mdix, dix_to_cas, cas_to_rpc,
                           ...
                           cas_fom_to_crow_fom, s3_request_to_motr,
...
class ADDB2PP:
    ...
    def __init__(self):
        self.parsers = {
            ...
            "s3-request-to-motr"   : (ADDB2PP.p_1_to_2,  "s3_request_to_motr"),
...
def db_consume_data(files: List[str], db):
    if len(files) == 0:
        return
...
if __name__ == '__main__':
    ...
    db_consume_data(args.dumps, args.db)
