            ...
            while count < linecount:
                ...
                if '''"Operation":''' in lines[count].replace(" ", ""):
                    ...
                    if opname in oplist:
                        ...
                        data = s3bench(filename, opname, iops, throughput, lat, ttfb, obj, Build, Version, Branch, OS,
                                       nodes_num, clients_num, col, Config_ID, overwrite, sessions, Objects, pc_full, custom, Run_Health)
