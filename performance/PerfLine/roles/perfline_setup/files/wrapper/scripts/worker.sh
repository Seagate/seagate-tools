...
function cleanup_logs() {
    ...
    # delete all addb files generated by Motr (R2 clusters)
    pdsh -S -w $NODES 'rm -rf /var/motr/m0d-*/addb-stobs-*' || true

    # delete all m0trace files generated by Motr (R2 clusters)
    pdsh -S -w $NODES 'rm -rf /var/motr/m0d-*/m0trace.*' || true
